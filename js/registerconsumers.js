...
MESSAGEREGISTRY.register('RENDERACTOR', MESSAGETYPES.CHECKSPACING, {
  ID: 'string', OPTIONS: 'object?'
}, RENDERBEHAVIOR);

MESSAGEREGISTRY.register('RENDERACTOR', MESSAGETYPES.CHECKOVERLAP, {
  ID: 'string', OPTIONS: 'object?'
}, RENDERBEHAVIOR);

MESSAGEREGISTRY.register('RENDERACTOR', MESSAGETYPES.CHECKSCROLLABILITY, {
  ID: 'string', OPTIONS: 'object?'
}, RENDERBEHAVIOR);

MESSAGEREGISTRY.register('RENDERACTOR', MESSAGETYPES.CHECKCONTROLLEDOVERLAY, {
  ID: 'string', OPTIONS: 'object?'
}, RENDERBEHAVIOR);

MESSAGEREGISTRY.register('RENDERACTOR', MESSAGETYPES.CORRECTOVERFLOW, {
  ID: 'string', OPTIONS: 'object?'
}, RENDERBEHAVIOR);

MESSAGEREGISTRY.register('RENDERACTOR', MESSAGETYPES.CORRECTSPACING, {
  ID: 'string', OPTIONS: 'object?'
}, RENDERBEHAVIOR);

MESSAGEREGISTRY.register('RENDERACTOR', MESSAGETYPES.CORRECTOVERLAP, {
  ID: 'string', OPTIONS: 'object?'
}, RENDERBEHAVIOR);

MESSAGEREGISTRY.register('RENDERACTOR', MESSAGETYPES.CORRECTSCROLLABILITY, {
  ID: 'string', OPTIONS: 'object?'
}, RENDERBEHAVIOR);

MESSAGEREGISTRY.register('RENDERACTOR', MESSAGETYPES.CORRECTCONTROLLEDOVERLAY, {
  ID: 'string', OPTIONS: 'object?'
}, RENDERBEHAVIOR);
...
MESSAGEREGISTRY.register('RENDERACTOR', MESSAGETYPES.OPTIMIZEHARMONY, {
  ID: 'string', THEMESTYLES: 'object?', OPTIONS: 'object?'
}, RENDERBEHAVIOR);

MESSAGEREGISTRY.register('RENDERACTOR', MESSAGETYPES.OPTIMIZETEXTVISIBILITY, {
  ID: 'string', THEMESTYLES: 'object?', OPTIONS: 'object?'
}, RENDERBEHAVIOR);

MESSAGEREGISTRY.register('RENDERACTOR', MESSAGETYPES.OPTIMIZEBUTTONVISIBILITY, {
  ID: 'string', THEMESTYLES: 'object?', OPTIONS: 'object?'
}, RENDERBEHAVIOR);

MESSAGEREGISTRY.register('RENDERACTOR', MESSAGETYPES.VERIFYCONTRAST, {
  ID: 'string', MINRATIO: 'number?'
}, RENDERBEHAVIOR);

MESSAGEREGISTRY.register('RENDERACTOR', MESSAGETYPES.VERIFYTEXTVISIBILITY, {
  ID: 'string'
}, RENDERBEHAVIOR);

MESSAGEREGISTRY.register('RENDERACTOR', MESSAGETYPES.VERIFYBUTTONVISIBILITY, {
  ID: 'string'
}, RENDERBEHAVIOR);

MESSAGEREGISTRY.register('RENDERACTOR', MESSAGETYPES.VERIFYHARMONY, {
  ID: 'string', OPTIONS: 'object?'
}, RENDERBEHAVIOR);

MESSAGEREGISTRY.register('RENDERACTOR', MESSAGETYPES.CHECKFOCUSVISIBILITY, {
  ID: 'string'
}, RENDERBEHAVIOR);
