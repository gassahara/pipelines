...
var PIPELINES_MANIFEST = [
  ...
  { src: 'js/actors/mailactor.js', provides: ['MAILACTOR', 'startMailActor', 'sendInstruction', 'sendResponse', 'generateTag'], owner: 'mailactor', types: ['send', 'ack'] },
  ...
  { src: 'js/registerconsumers.js', provides: ['REGISTERED_CONSUMERS'] }
];
