...
var PIPELINES_MANIFEST = [
  ...
  { src: 'actors/mailactor.js', provides: ['MAILACTOR', 'startMailActor', 'sendInstruction', 'requestUnreadMessages', 'sendResponse', 'awaitResponse', 'generateTag'], owner: 'mailactor', types: ['send', 'poll', 'ack'] },
