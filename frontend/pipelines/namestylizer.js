function applynamestheme(contenthtml, referencehtml, frameworkfunctions, parser) {
  ...
  if (!domparserctor || typeof domparserctor !== 'function') {
    throw new Error('[applynamestheme] DOMParser not available; provide a parser.');
  }
  ...
  var procedurehighlightbg = colorharmony.pick(
    colorharmony.monochromatic(bg, 4, undefined, colorcore),
    1
  );
  ...
  var ruledefs = [
    { id: 'namespane', style: { backgroundColor: bg, color: text, fontFamily: fontfamily, fontSize: fontsize } },
...
if (typeof module !== 'undefined' && module.exports) {
  module.exports = {
    applynamestheme: applynamestheme
  };
}
